...
export function Card({ children, className, variant = "solid", ...props }: CardProps) {
  ...
  const variants = {
    ...
    solid: "bg-white border-[#2C2420]/10 shadow-[0_8px_30px_rgba(44,36,32,0.04)]",
    ...
    interactive: "bg-white border-[#2C2420]/10 shadow-sm hover:shadow-[0_20px_40px_rgba(44,36,32,0.08)] hover:-translate-y-1 hover:border-[#D4AF37]/30 cursor-pointer"
  };
...
export function CardHeader({ children, className }: { children: React.ReactNode, className?: string }) {
  return <div className={`px-6 py-5 border-b border-[#2C2420]/5 flex items-center justify-between ${className || ""}`}>{children}</div>;
}
