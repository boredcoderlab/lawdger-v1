...
**Last updated:** 2026-07-17 (post-WS5 merge #45 — flip #12; N71/N76 codicils (updateTaskAssignee fallthrough correction, @dnd-kit/core-only reinstall), line-353 sidebar completed-state closed, open-verify added (session-name staleness, no N-number), Fable ledger spent (0 remaining) at `c35f0d3`; §2 pointer advanced `eaa71d1`→`c35f0d3`)
...
- **Default branch:** `main`
- **Current main sha:** `c35f0d3` (#45 — WS5 Kanban drag-drop squash-merge; last feature merge)
- **Last merge:** #45 WS5 — Kanban drag-drop on /tasks + sidebar completed-state styling (`c35f0d3`)
