...
**Last updated:** 2026-07-18 (post-W9 PR2 merge #46 — flip #13; Case.nextHearingDate column dropped, live CalendarEvent groupBy migration via getNextHearingDatesByCase helper, calendar-sync.ts + backfill + stale-past filter deletion, CalendarEvent(caseId, hearingDate) composite index added, zero verify delta (50/9 held) at `702407f`; §2 pointer advanced `c35f0d3`→`702407f`)
...
- **Default branch:** `main`
- **Current main sha:** `702407f` (#46 — W9 PR2 schema cleanup squash-merge; last feature merge)
- **Last merge:** #46 W9 PR2 — Case.nextHearingDate column dropped, live CalendarEvent groupBy migration (`702407f`)
