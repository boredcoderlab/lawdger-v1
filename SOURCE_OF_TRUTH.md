...
**Last updated:** 2026-07-19 (post-W10a merge #48 — flip #15; rescoped false "End-to-End Encrypted Workspace" badge to "Encrypted in transit & at rest" at SettingsClient.tsx:235, closes N56 UI-badge portion (Gemini-retention portion remains open, tracked W10b); §11 E2E marketing-claim fork resolved; baseline unchanged 51/9 at `4d434c8`; §2 pointer advanced `1738326`→`4d434c8`; N56 partially closed)
...
- **N56 (P2)** — UI asserts "End-to-End Encrypted Workspace" — false: server-side AI processing; voice audio is written to server tmpdir and uploaded to Gemini File API. SOT §11 flags the pitch-deck claim; the in-app badge was uncatalogued. For a legal-confidentiality product this is a liability, not copy polish. Evidence: SettingsClient.tsx:235; supporting: transcribe/route.ts:43–51. Fix direction: Rescope to "Encrypted in transit & at rest"; pair with Gemini-retention verification. Resolution: W10. **W10a ✅ @ `4d434c8` (#48)**: UI-badge portion closed — badge text rescoped to "Encrypted in transit & at rest" at SettingsClient.tsx:235. Gemini-retention portion (data-training/retention verification) remains **OPEN** — tracked as W10b, not yet executed.
...
| W10 | Trust-claims reconciliation (N56) (W10a ✅ / W10b pending) | **W10a ✅ @ `4d434c8` (#48)** — Badge rescoped from "End-to-End Encrypted Workspace" to "Encrypted in transit & at rest" (SettingsClient.tsx:235). Closes N56 UI-badge portion. **W10b pending** — Gemini API training/retention verification (N56's other half, §11 fork). | Parallel |
