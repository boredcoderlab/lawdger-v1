...
**Last updated:** 2026-07-19 (post-W9 PR3 merge #47 — flip #14; deleteCase wrapped in withServerUserContext for multi-write atomicity, document.deleteMany added closing N59's Document-orphan gap, Check 9 added to verify-phase32-rls.ts (cross-tenant Document isolation, structural-only per N40), baseline 50/9 → 51/9 at `1738326`; §2 pointer advanced `702407f`→`1738326`; N59 closed, N87 reserved)
...
- **Default branch:** `main`
- **Current main sha:** `1738326` (#47 — W9 PR3 deleteCase atomicity squash-merge; last feature merge)
- **Last merge:** #47 W9 PR3 — deleteCase wrapped in withServerUserContext, document.deleteMany added, N59 closed (`1738326`)
