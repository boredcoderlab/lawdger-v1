...
- **N53 (P2)** — getTasks + updateTaskAssignee: last two bare-Prisma functions, both dead code (zero callers). Every day they exist they invite a new caller into the N38 trap. Evidence: taskActions.ts:26–33, 167–179. Fix direction: Delete (PR8 WS1 fe73e73 already does — lands via W1). If drag-drop needs assignee updates, updateCaseTask now covers it. Resolution: W1.
